...
8. Get Eventwith the smallest time in the priority queue; thisisthe current_event.
...
14. If StopIteration israised, delete the coroutine from the self.procs dictionary.
