...
- caller
    ...
    PEP 380使用术语“caller”去描述调用delegating generator的客户代码。依赖此背景，我用“client”而不是“caller”去区别那些也被成为“caller”的delegating generator（他实际调用的是subgenerator）。
...
>PEP 380经常使用单词“iterator”去指代subgeneratro。这是
